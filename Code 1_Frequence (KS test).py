"""""""""""""""""""""""""""""""""""
This script processes defoliation data files and generates combined plots of frequency distribution and Kolmogorov-Smirnov (KS test) statistics heatmap.
...
ks_colors = ['#98DCED', '#A0BEF5', '#D88BF2', '#9D2BC2']  # KS plot colors
start_color = '#f7f7f7'  # KS plot start color
end_color = '#525252'  # KS plot end color
